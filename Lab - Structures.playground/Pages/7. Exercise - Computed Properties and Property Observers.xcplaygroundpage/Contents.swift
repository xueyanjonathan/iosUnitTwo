...
var rec = Rectangle(width: 5, height: 6)
print(rec.area)
/*:
...
var tall = Height(heightInCentimeters: 25.4)
print(tall.heightInInches)
var big = Height(heightInInches: 10)
print(tall.heightInCentimeters)
