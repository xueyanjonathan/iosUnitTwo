 ...
 */
print("The value is nil because 34e is not an integer. The optional Int? allows the program to give a nil instead of having an error.")
 ...
 */
print("The value has a 'optional' notification.")
print(userAge!)
/*:
