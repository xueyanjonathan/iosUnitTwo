 ...
 */
if let computerOne = Computer(ram: 5, yearManufactured: 2016) {
    print(computerOne.ram)
    print(computerOne.yearManufactured)
}
if let computerTwo = Computer(ram: -1, yearManufactured: 2018) {
    print(computerTwo.ram)
    print(computerTwo.yearManufactured)
}
